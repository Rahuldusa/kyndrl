...
var checker_form = document.getElementById('checker_form');
...
function Submit_function() {        
    var apiUrl = 'checker_emp_page';  // URL to your Django view

    // Create a new form dynamically
    var newForm = document.createElement("form");
    newForm.action = apiUrl;
    newForm.method = checker_form.method;  // Preserving the method (GET/POST) from the original form
    ...
    var formData = new FormData(checker_form);
...
function Submit_1_function() {    
    var apiUrl = 'checker_control_number'
    checker_form.action = apiUrl;
    checker_form.submit();
}
